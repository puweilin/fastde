...
dgCMatrix64 can be serialized to and deserialized from HDF5 files with the provided functions `Write10X_h5` and `Read10X_h5` functions.  Both will adapt to data size automatically to accept or product `dgCMatrix` or `dgCMatrix64` objects. 
...
# read
spmat_2 = fastde::Read10X_h5("test_spmat.h5")

# write 
fastde::Write10X_h5(spmat64, "test_spmat64.h5")

# read
spmat64_2 = fastde::Read10X_h5("test_spmat64.h5")
```
